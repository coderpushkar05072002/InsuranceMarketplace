...
// ---------------- Blockchain Config ----------------
export const contractAddress = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; // apna actual contract address yaha paste karo
...
export const contractABI = [
  ...
  // yaha Insurance.sol ka ABI paste karo
];

// ---------------- Backend API Calls ----------------

// Buy Insurance
export async function buyInsurance(policyId, premium) {
  try {
    const res = await fetch(`${API_BASE}/buyInsurance`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ policyId, premium }),
    });
...
export async function claimInsurance(policyId, amount) {
  try {
    const res = await fetch(`${API_BASE}/claimInsurance`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export async function getPolicy(policyId) {
  try {
    const res = await fetch(`${API_BASE}/getPolicy/${policyId}`);
    return await res.json();
  } catch (err) {
